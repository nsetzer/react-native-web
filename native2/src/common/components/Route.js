...
platformPosition = (Platform.OS === 'web')?'fixed':'absolute'
...
class INavMenu extends React.Component {
    ...
    render () {
        ...
        // <Svg src={obj.icon.url} style={obj.icon.style}/>
        // {(obj.icon && obj.icon.url)?null:null}
        ...
        */
        ...
        zIndex = (style?(style.zIndex?style.zIndex:20):20)
        backgroundColor = (style?(style.backgroundColor?style.backgroundColor:'white'):'white')

        // order of components is important for RN on Android
        // zIndex is largely ignored
        return (
            <View>
